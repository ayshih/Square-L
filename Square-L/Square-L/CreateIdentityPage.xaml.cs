...
namespace Square_L
{
    public partial class CreateIdentityPage : PhoneApplicationPage
    {
        ...
        private async void SaveIdentity()
        {
            ...
            var identity = new Identity() { nickname = NicknameBox.Text, lastUsed = DateTime.Now, masterKey = masterKey, passwordSalt = passwordSalt, passwordHash = passwordHash, parameters = parameters };
